    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='article_updated_by', to=settings.AUTH_USER_MODEL, verbose_name='Автор обновления')),
            ],
            options={
                'verbose_name': 'Статья',
